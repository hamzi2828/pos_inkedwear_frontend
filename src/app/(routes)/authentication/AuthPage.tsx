...
import { setToken, setRole, setPermissions, setEmployeeId } from "@/helper/helper";
    ...
    try {
      ...
      if (isForgot) {
        ...
        try {
          ...
          // Persist permissions for sidebar and route guards
          if (res?.data?.permissions) {
            setPermissions(res.data.permissions);
          }
          // Persist employeeId for activity logging
