                ...
                <div className="bg-white rounded-lg shadow-sm p-6 lg:p-8 lg:pt-0">
                  ...
                  <div className="space-y-6">
                    ...
                    <article className="privacy-faq-question-border pb-6">
                      ...
                      >
                        <p>
                          Browse our 3BAMCARS collection and click <span className="privacy-faq-link">Add to Cart</span>
                    ...
                    <article className="privacy-faq-question-border pb-6">
                      ...
                      >
                        <p>
                          ...
                          select an alternative 3BAMCARS item. Full refunds are
                          available if needed.
                        </p>
                      </div>
                    </article>
                    ...
                    <article className="privacy-faq-question-border pb-6">
                      ...
                      >
                        <p>
                          ...
                          from XS to XXL for all our 3BAMCARS collections.
                        </p>
                      </div>
                    </article>
                  </div>
